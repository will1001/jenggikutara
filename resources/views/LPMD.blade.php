...
<body data-spy="scroll" data-target="#primary-menu">
    ...
    <section id="lembaga" class="section-padding">
      <div class="container">
      <h1 class="text-center text-uppercase">lembaga pemberdayaan masyarakat desa (lpmd) Desa Jenggik Utara</h1>
       <div class="row">
      ...
      <div class="row" id="visimisi">
        <div class="col-md-12">
          ...
          <img src="images/.jpg" alt="grafik organisasi">
          </div>
          <h4 class="text-center">Visi</h4>
          <p>Terwujudnya Masyarakat Desa Jenggik Utara yang mandiri, aktif dan responsif terhadap kemajuan Pembangunan”</p>
          <h4 class="text-center">Misi</h4>
          <ul>
            <li>Menggali potensi yang ada di Desa Jenggik Utara.</li>
            <li>Meningkatkan kualitas kehidupan sosial ekonomi Masyarakat Desa Jenggik Utara.</li>
            ...
            <li>Sebagai mitra pemerintahan Desa Jenggik Utara.</li>
          </ul>
